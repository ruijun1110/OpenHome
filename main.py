...
def main():
    conf = AutoConfig(Config(temperature=0.1, repetition_penalty=1.1, batch_size=52,max_new_tokens=50, context_length=2048))
    llm = AutoModelForCausalLM.from_pretrained("./zephyr-7b-beta.Q5_K_S.gguf", model_type="gptq", config = conf)
